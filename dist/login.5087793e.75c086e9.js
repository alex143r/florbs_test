...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"login.5087793e.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (modules, cache, entry, globalName) {
  ...
  "node_modules/micro-api-client/lib/pagination.js": [function (require, module, exports) {
    "use strict";
  ...
  "node_modules/micro-api-client/lib/index.js": [function (require, module, exports) {
    "use strict";
    ...
    var API = function () {
      ...
      _createClass(API, [{
        ...
        value: function request(path) {
          ...
          return fetch(this.apiURL + path, _extends({}, options, {
            headers: headers
    ...
    "./pagination": "node_modules/micro-api-client/lib/pagination.js"
  }],
  "node_modules/gotrue-js/lib/admin.js": [function (require, module, exports) {
    "use strict";
  ...
  "node_modules/gotrue-js/lib/user.js": [function (require, module, exports) {
    "use strict";
    ...
    "micro-api-client": "node_modules/micro-api-client/lib/index.js",
    "./admin.js": "node_modules/gotrue-js/lib/admin.js"
  }],
  "node_modules/gotrue-js/lib/index.js": [function (require, module, exports) {
    "use strict";
    ...
    "micro-api-client": "node_modules/micro-api-client/lib/index.js",
    "./user.js": "node_modules/gotrue-js/lib/user.js"
  }],
  "login.js": [function (require, module, exports) {
    ...
    function initListeners() {
      ...
      document.querySelector(".forgot-back-btn").addEventListener("click", toggleExisting);
    }
    ...
    function toggleBackForgot() {} //Instantiate the GoTrue auth client + GoTrue functions
    ...
    document.querySelector("form[name='signup']").addEventListener("submit", function (e) {
      ...
      if (e.target.elements.password.value === e.target.elements.password2.value) {
        ...
        var _form$elements = form.elements,
            email = _form$elements.email,
            password = _form$elements.password;
        auth.signup(email.value, password.value).then(function (response) {
          console.log(response);
          showMessage("<p>Created a user! </p><p>Response: </p><code>".concat(JSON.stringify(response), "</code>"), form);
        }).catch(function (error) {
          showMessage("Failed :( <code>".concat(JSON.stringify(error), "</code>"), form);
          console.log(error);
        });
      } else {
    ...
    "gotrue-js": "node_modules/gotrue-js/lib/index.js"
  }],
