...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"materialize.min.510bb6ec.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (e, r, t, n) {
  ...
  "RToB": [function (require, module, exports) {
    var define;
    ...
    window.cash = function () {
      var t,
          ...
          r = function r() {},
          l = function l(t) {
        return _typeof(t) == _typeof(r) && t.call;
      },
          h = function h(t) {
      ...
      function g(t, n) {
        ...
        var s,
            o = t,
            a = 0;
        if (h(t)) o = d.test(t) ? e.getElementById(t.slice(1)) : c.test(t) ? f(t) : v(t, n);else if (l(t)) return m(t), this;
        if (!o) return this;
        if (o.nodeType || o === i) this[0] = o, this.length = 1;else for (s = this.length = o.length; a < s; a++) {
          this[a] = o[a];
        }
        return this;
      }
      ...
      function x(t, e) {
        var i = M(t);
        return void 0 === i[e] && (i[e] = t.dataset ? t.dataset[e] : y(t).attr("data-" + e)), i[e];
      }
      ...
      _.extend({
        ...
        removeData: function removeData(t) {
          return this.each(function (e) {
            return n = t, void ((s = M(i = e)) ? delete s[n] : i.dataset ? delete i.dataset[n] : y(i).removeAttr("data-" + name));
            var i, n, s;
          });
        }
      });
      ...
      var S,
          ...
          R,
          H,
          P = (R = /(?:^\w|[A-Z]|\b\w)/g, H = /[\s-_]+/g, function (t) {
      ...
      y.prefixedProp = W, y.camelCase = P, _.extend({
        ...
        on: function on(t, e, i, n) {
          ...
          return l(e) && (i = e, e = null), "ready" === t ? (m(i), this) : (e && (s = i, i = function i(t) {
            ...
            var s,
                ...
                _l = i;
            n && (_l = function l() {
              i.apply(this, arguments), F(e, t, _l);
            }), o = t, a = _l, (r = x(s = e, "_cashEvents") || O(s, "_cashEvents", {}))[o] = r[o] || [], r[o].push(a), s.addEventListener(o, a);
          }));
        },
      ...
      return _.extend({
        ...
        parents: function parents(t) {
          ...
          return this.each(function (s) {
            for (i = s; i && i.parentNode && i !== e.body.parentNode;) {
              i = i.parentNode, (!t || t && b(i, t)) && n.push(i);
            }
          }), C(n);
        },
        prev: function prev() {
    ...
    }(window), "function" == typeof t && t.amd ? t("M", [], function () {
      return M;
    ...
    document.addEventListener("keydown", l, !0), document.addEventListener("keyup", h, !0), document.addEventListener("focus", d, !0), document.addEventListener("blur", u, !0), M.initializeJqueryWrapper = function (t, e, i) {
      jQuery.fn[e] = function (n) {
        ...
        if ("object" == _typeof(n) || !n) return t.init(this, n), this;
    ...
    M.throttle = function (t, e, i) {
      ...
      var l = function l() {
        r = !1 === i.leading ? 0 : c(), a = null, o = t.apply(n, s), n = s = null;
      };
    ...
    p.defineProperty = "function" == typeof Object.defineProperties ? Object.defineProperty : function (t, e, i) {
    ...
    }, p.getGlobal = function (t) {
      return "undefined" != typeof window && window === t ? t : void 0 !== e && null != e ? e : t;
    }, p.global = p.getGlobal(this), p.SYMBOL_PREFIX = "jscomp_symbol_", p.initSymbol = function () {
      p.initSymbol = function () {}, p.global.Symbol || (p.global.Symbol = p.Symbol);
    }, p.symbolCounter_ = 0, p.Symbol = function (t) {
      return p.SYMBOL_PREFIX + (t || "") + p.symbolCounter_++;
    }, p.initSymbolIterator = function () {
      p.initSymbol();
      var t = p.global.Symbol.iterator;
      t || (t = p.global.Symbol.iterator = p.global.Symbol("iterator")), "function" != typeof Array.prototype[t] && p.defineProperty(Array.prototype, t, {
        configurable: !0,
        writable: !0,
    ...
    }, p.iteratorPrototype = function (t) {
      return p.initSymbolIterator(), (t = {
        next: t
      })[p.global.Symbol.iterator] = function () {
        return this;
      }, t;
    }, p.array = p.array || {}, p.iteratorFromArray = function (t, e) {
      ...
      if (e) {
        ...
        (e = e(n = i[t = t[t.length - 1]])) != n && null != e && p.defineProperty(i, t, {
          configurable: !0,
          writable: !0,
          value: e
        });
      }
    }, p.polyfill("Array.prototype.keys", function (t) {
      return t || function () {
        return p.iteratorFromArray(this, function (t) {
          return t;
        });
      };
    }, "es6-impl", "es3");
    ...
    M.anime = function () {
      ...
      function c(t, i) {
        switch (u(t, i)) {
          case "transform":
            return function (t, i) {
              var n,
                  s = -1 < (n = i).indexOf("translate") || "perspective" === n ? "px" : -1 < n.indexOf("rotate") || -1 < n.indexOf("skew") ? "deg" : void 0;
              s = -1 < i.indexOf("scale") ? 1 : 0 + s;
              if (!(t = t.style.transform)) return s;

              for (var o = [], a = [], r = [], l = /(\w+)\((.+?)\)/g; o = l.exec(t);) {
        ...
        return t.tweens.map(function (n) {
          var s = (n = function (t, e) {
            ...
            return n.duration = parseFloat(n.duration), n.delay = parseFloat(n.delay), n;
              ...
              o = c(e.target, t.name),
              a = i ? i.to.original : o,
              r = (a = B.arr(s) ? s[0] : a, p(B.arr(s) ? s[1] : s, a));
          ...
          }(n.easing), n.elasticity = (1e3 - Math.min(Math.max(n.elasticity, 1), 999)) / 1e3, n.isPath = B.pth(s), n.isColor = B.col(n.from.original), n.isColor && (n.round = 1), i = n;
        });
      }
      ...
      function E(t) {
        var n,
            ...
            h = a(x, t),
            d = a(L, t),
            c = (s = t.targets, (o = k(s)).map(function (t, e) {
          return {
            target: t,
            id: e,
            total: o.length
        ...
        for (n in t) {
          v.hasOwnProperty(n) || "targets" === n || p.push({
            name: n,
            offset: v.offset,
            tweens: b(t[n], d)
          });
      ...
      function M(t) {
        ...
        function s(t) {
          for (var i = 0, n = {}, s = v.animations, o = s.length; i < o;) {
            ...
            for (var h = Math.min(Math.max(t - l.start - l.delay, 0), l.duration) / l.duration, u = isNaN(h) ? 1 : l.easing(h, l.elasticity), c = (h = l.to.strings, l.round), p = [], f = void 0, m = (f = l.to.numbers.length, 0); m < f; m++) {
              ...
              g = l.isPath ? y(l.value, u * g) : _ + u * (g - _);
              c && (l.isColor && 2 < m || (g = Math.round(g * c) / c)), p.push(g);
            }

            if (l = h.length) for (f = h[0], u = 0; u < l; u++) {
              c = h[u + 1], m = p[u], isNaN(m) || (f = c ? f + (m + c) : f + (m + " "));
            } else f = p[0];
            S[a.type](r.target, a.property, f, n, r.id), a.currentValue = f, i++;
          }

          if (i = Object.keys(n).length) for (s = 0; s < i; s++) {
            O || (O = d(document.body, "transform") ? "transform" : "-webkit-transform"), v.animatables[s].target.style[O] = n[s].join(" ");
          }
        ...
        function r(t) {
          ...
          if (v.children.length) {
            var y = v.children,
                _ = y.length;
            if (g >= v.currentTime) for (var k = 0; k < _; k++) {
              y[k].seek(g);
            } else for (; _--;) {
              y[_].seek(g);
            }
      ...
      var O,
        ...
        for (e in n) {
          o.type = e, n[o.type].forEach(function (t) {
            return function (e, n) {
              s["ease" + t.type + i[n]] = B.fnc(e) ? e : D.apply(v, e);
            };
          }(o)), o = {
            type: o.type
          };
      ...
      var l = {
        ...
        function d(e, i) {
          ...
          (n.el.M_Collapsible = n).options = t.extend({}, d.defaults, i), n.$headers = n.$el.children("li").children(".collapsible-header"), n.$headers.attr("tabindex", 0), n._setupEventHandlers();
        ...
        return o(d, r), n(d, [{
          ...
          value: function value(t, e) {
            return i(d.__proto__ || Object.getPrototypeOf(d), "init", this).call(this, this, t, e);
          }
        }, {
          key: "getInstance",
          value: function value(t) {
      ...
      h._dropdowns = [], window.M.Dropdown = h, M.jQueryLoaded && M.initializeJqueryWrapper(h, "dropdown", "M_Dropdown");
    }(cash, M.anime), function (t, e) {
      "use strict";
      ...
      var l = {
        ...
        function d(e, i) {
          a(this, d);
          var n = s(this, (d.__proto__ || Object.getPrototypeOf(d)).call(this, d, e, i));
          return (n.el.M_Modal = n).options = t.extend({}, d.defaults, i), n.isOpen = !1, n.id = n.$el.attr("id"), n._openingTrigger = void 0, n.$overlay = t('<div class="modal-overlay"></div>'), n.el.tabIndex = 0, n._nthModalOpened = 0, d._count++, n._setupEventHandlers(), n;
        }
        ...
        return o(d, r), n(d, [{
          ...
          key: "_handleFocus",
          value: function value(t) {
            this.el.contains(t.target) || this._nthModalOpened !== d._modalsOpen || this.el.focus();
          }
        }, {
          key: "_animateIn",
          value: function value() {
      ...
      var l = {
        ...
        function d(e, i) {
          a(this, d);
          var n = s(this, (d.__proto__ || Object.getPrototypeOf(d)).call(this, d, e, i));
          return (n.el.M_Materialbox = n).options = t.extend({}, d.defaults, i), n.overlayActive = !1, n.doneAnimating = !0, n.placeholder = t("<div></div>").addClass("material-placeholder"), n.originalWidth = 0, n.originalHeight = 0, n.originInlineStyles = n.$el.attr("style"), n.caption = n.el.getAttribute("data-caption") || "", n.$el.before(n.placeholder), n.placeholder.append(n.$el), n._setupEventHandlers(), n;
        }
      ...
      var e = {
        ...
        function h(e, i) {
          ...
          return (n.el.M_Parallax = n).options = t.extend({}, h.defaults, i), n._enabled = window.innerWidth > n.options.responsiveThreshold, n.$img = n.$el.find("img").first(), n.$img.each(function () {
            this.complete && t(this).trigger("load");
          }), n._updateParallax(), n._setupEventHandlers(), n._setupStyles(), h._parallaxes.push(n), n;
        }

        return o(h, r), n(h, [{
          key: "destroy",
          value: function value() {
            h._parallaxes.splice(h._parallaxes.indexOf(this), 1), this.$img[0].style.transform = "", this._removeEventHandlers(), this.$el[0].M_Parallax = void 0;
          }
        }, {
          key: "_setupEventHandlers",
          value: function value() {
            this._handleImageLoadBound = this._handleImageLoad.bind(this), this.$img[0].addEventListener("load", this._handleImageLoadBound), 0 === h._parallaxes.length && (h._handleScrollThrottled = M.throttle(h._handleScroll, 5), window.addEventListener("scroll", h._handleScrollThrottled), h._handleWindowResizeThrottled = M.throttle(h._handleWindowResize, 5), window.addEventListener("resize", h._handleWindowResizeThrottled));
          }
        }, {
          key: "_removeEventHandlers",
          value: function value() {
            this.$img[0].removeEventListener("load", this._handleImageLoadBound), 0 === h._parallaxes.length && (window.removeEventListener("scroll", h._handleScrollThrottled), window.removeEventListener("resize", h._handleWindowResizeThrottled));
          }
        }, {
          key: "_setupStyles",
          value: function value() {
          ...
          key: "init",
          value: function value(t, e) {
            return i(h.__proto__ || Object.getPrototypeOf(h), "init", this).call(this, this, t, e);
          }
        }, {
          key: "getInstance",
          value: function value(t) {
      ...
      var l = {
        ...
        function d(e, i) {
          a(this, d);
          var n = s(this, (d.__proto__ || Object.getPrototypeOf(d)).call(this, d, e, i));
          return (n.el.M_Tabs = n).options = t.extend({}, d.defaults, i), n.$tabLinks = n.$el.children("li.tab").children("a"), n.index = 0, n._setupActiveTabLink(), n.options.swipeable ? n._setupSwipeableTabs() : n._setupNormalTabs(), n._setTabsAndTabWidth(), n._createIndicator(), n._setupEventHandlers(), n;
        }
      ...
      window.M.Tabs = h, M.jQueryLoaded && M.initializeJqueryWrapper(h, "tabs", "M_Tabs");
    }(cash, M.anime), function (t, e) {
      "use strict";
      ...
      var l = {
        ...
        function d(e, i) {
          a(this, d);
          var n = s(this, (d.__proto__ || Object.getPrototypeOf(d)).call(this, d, e, i));
          return (n.el.M_Tooltip = n).options = t.extend({}, d.defaults, i), n.isOpen = !1, n.isHovered = !1, n.isFocused = !1, n._appendTooltipEl(), n._setupEventHandlers(), n;
        }
      ...
      var i = {
        ...
        return n(s, [{
          ...
          value: function value() {
            var e = document.createElement("div");
            return e.classList.add("toast"), this.options.classes.length && t(e).addClass(this.options.classes), ("object" == (typeof HTMLElement === "undefined" ? "undefined" : _typeof(HTMLElement)) ? this.message instanceof HTMLElement : this.message && "object" == _typeof(this.message) && null !== this.message && 1 === this.message.nodeType && "string" == typeof this.message.nodeName) ? e.appendChild(this.message) : this.message.jquery ? t(e).append(this.message[0]) : e.innerHTML = this.message, s._container.appendChild(e), e;
          }
        }, {
          key: "_animateIn",
          value: function value() {
          ...
          value: function value(e) {
            if (e.target && t(e.target).closest(".toast").length) {
              ...
              i.panning = !0, (s._draggedToast = i).el.classList.add("panning"), i.el.style.transition = "", i.startingXPos = s._xPos(e), i.time = Date.now(), i.xPos = s._xPos(e);
            }
          }
        }, {
          key: "_onDragMove",
      ...
      s._toasts = [], s._container = null, s._draggedToast = null, M.Toast = s, M.toast = function (t) {
        return new s(t);
      };
    }(cash, M.anime), function (t, e) {
      "use strict";
      ...
      var l = {
        ...
        function d(e, i) {
          a(this, d);
          var n = s(this, (d.__proto__ || Object.getPrototypeOf(d)).call(this, d, e, i));
          return (n.el.M_Sidenav = n).id = n.$el.attr("id"), n.options = t.extend({}, d.defaults, i), n.isOpen = !1, n.isFixed = n.el.classList.contains("sidenav-fixed"), n.isDragged = !1, n.lastWindowWidth = window.innerWidth, n.lastWindowHeight = window.innerHeight, n._createOverlay(), n._createDragTarget(), n._setupEventHandlers(), n._setupClasses(), n._setupFixed(), d._sidenavs.push(n), n;
        }
      ...
      h._sidenavs = [], window.M.Sidenav = h, M.jQueryLoaded && M.initializeJqueryWrapper(h, "sidenav", "M_Sidenav");
    }(cash, M.anime), function (t, e) {
      "use strict";
      ...
      var l = {
        ...
        function d(e, i) {
          a(this, d);
          var n = s(this, (d.__proto__ || Object.getPrototypeOf(d)).call(this, d, e, i));
          return (n.el.M_ScrollSpy = n).options = t.extend({}, d.defaults, i), d._elements.push(n), d._count++, d._increment++, n.tickId = -1, n.id = d._increment, n._setupEventHandlers(), n._handleWindowScroll(), n;
        }
        ...
        return o(d, r), n(d, [{
          ...
          value: function value(i) {
            for (var n = t(i.target), s = d._elements.length - 1; 0 <= s; s--) {
              var o = d._elements[s];
          ...
          value: function value() {
            ...
            (d._visibleElements = d._visibleElements.filter(function (t) {
              return 0 != t.height();
            }))[0] && (t(this.options.getActiveElement(d._visibleElements[0].attr("id"))).removeClass(this.options.activeClass), (d._visibleElements = d._visibleElements.filter(function (t) {
              return t.attr("id") != e.$el.attr("id");
            }))[0] && t(this.options.getActiveElement(d._visibleElements[0].attr("id"))).addClass(this.options.activeClass));
          }
        }], [{
          key: "init",
          value: function value(t, e) {
      ...
      var e = {
        ...
        function h(e, i) {
          a(this, h);
          var n = s(this, (h.__proto__ || Object.getPrototypeOf(h)).call(this, h, e, i));
          return (n.el.M_Autocomplete = n).options = t.extend({}, h.defaults, i), n.isOpen = !1, n.count = 0, n.activeIndex = -1, n.oldVal, n.$inputField = n.$el.closest(".input-field"), n.$active = t(), n._mousedown = !1, n._setupDropdown(), n._setupEventHandlers(), n;
        }
        ...
        return o(h, r), n(h, [{
          ...
          value: function value(e) {
            ...
            i === M.keys.ENTER && 0 <= this.activeIndex ? (n = t(this.container).children("li").eq(this.activeIndex)).length && (this.selectOption(n), e.preventDefault()) : i !== M.keys.ARROW_UP && i !== M.keys.ARROW_DOWN || (e.preventDefault(), i === M.keys.ARROW_UP && 0 < this.activeIndex && this.activeIndex--, i === M.keys.ARROW_DOWN && this.activeIndex < s - 1 && this.activeIndex++, this.$active.removeClass("active"), 0 <= this.activeIndex && (this.$active = t(this.container).children("li").eq(this.activeIndex), this.$active.addClass("active")));
          }
        }, {
      ...
      var l = {
        ...
        function d(i, n) {
          ...
          return (o.el.M_Slider = o).options = t.extend({}, d.defaults, n), o.$slider = o.$el.find(".slides"), o.$slides = o.$slider.children("li"), o.activeIndex = o.$slides.filter(function (e) {
      ...
      var e = {
        ...
        return o(h, r), n(h, [{
          ...
          value: function value(e) {
            h._keydown || (t(e.target).closest(".chips")[0].M_Chips._selectedChip = null);
          }
        }, {
          key: "defaults",
          get: function get() {
      ...
      var e = {
        ...
        function h(e, i) {
          a(this, h);
          var n = s(this, (h.__proto__ || Object.getPrototypeOf(h)).call(this, h, e, i));
          return (n.el.M_Pushpin = n).options = t.extend({}, h.defaults, i), n.originalOffset = n.el.offsetTop, h._pushpins.push(n), n._setupEventHandlers(), n._updatePosition(), n;
        }
        ...
        return o(h, r), n(h, [{
          ...
          key: "_setupEventHandlers",
          value: function value() {
            document.addEventListener("scroll", h._updateElements);
          }
        }, {
          key: "_removeEventHandlers",
          value: function value() {
            document.removeEventListener("scroll", h._updateElements);
          }
        }, {
          key: "_updatePosition",
          value: function value() {
          ...
          key: "_updateElements",
          value: function value() {
            for (var t in h._pushpins) {
              h._pushpins[t]._updatePosition();
            }
          }
        }, {
          key: "defaults",
      ...
      var e = {
        ...
        function h(e, i) {
          a(this, h);
          var n = s(this, (h.__proto__ || Object.getPrototypeOf(h)).call(this, h, e, i));
          (n.el.M_Datepicker = n).options = t.extend({}, h.defaults, i), i && i.hasOwnProperty("i18n") && "object" == _typeof(i.i18n) && (n.options.i18n = t.extend({}, h.defaults.i18n, i.i18n)), n.options.minDate && n.options.minDate.setHours(0, 0, 0, 0), n.options.maxDate && n.options.maxDate.setHours(0, 0, 0, 0), n.id = M.guid(), n._setupVariables(), n._insertHTMLIntoDOM(), n._setupModal(), n._setupEventHandlers(), n.options.defaultDate || (n.options.defaultDate = new Date(Date.parse(n.el.value)));
        ...
        return o(h, r), n(h, [{
          ...
          value: function value(t) {
            var e = this;
            return t = t || this.options.format, h._isDate(this.date) ? t.split(/(d{1,4}|m{1,4}|y{4}|yy|!.)/g).map(function (t) {
          ...
          value: function value(t, e) {
            ...
            if ("string" == typeof t && (t = new Date(Date.parse(t))), h._isDate(t)) {
              ...
              h._isDate(i) && t < i ? t = i : h._isDate(n) && n < t && (t = n), this.date = new Date(t.getTime()), this._renderDateDisplay(), h._setToStartOfDay(this.date), this.gotoDate(this.date), e || "function" != typeof this.options.onSelect || this.options.onSelect.call(this, this.date);
            }
          }
        }, {
          key: "setInputValue",
          ...
          value: function value(t, e, i) {
            ...
            h._setToStartOfDay(s), 0 < n.firstDay && (a -= n.firstDay) < 0 && (a += 7);

            for (var d = 0 === e ? 11 : e - 1, u = 11 === e ? 0 : e + 1, c = 0 === e ? t - 1 : t, p = 11 === e ? t + 1 : t, v = h._getDaysInMonth(c, d), f = o + a, m = f; 7 < m;) {
              m -= 7;
            }
            ...
            for (var g = !1, y = 0, _ = 0; y < f; y++) {
              ...
              var D = {
                ...
                isSelected: b,
                isToday: w,
                isDisabled: n.minDate && k < n.minDate || n.maxDate && k > n.maxDate || n.disableWeekends && h._isWeekend(k) || n.disableDayFn && n.disableDayFn(k),
                isEmpty: E,
                isStartRange: L,
                isEndRange: T,
                isInRange: B,
              ...
              l.push(this.renderDay(D)), 7 == ++_ && (r.push(this.renderRow(l, n.isRTL, g)), _ = 0, g = !(l = []));
            }
          ...
          value: function value(e, i, n, s, o, a) {
            ...
            for (u = [], h = 0; h < 12; h++) {
              u.push('<option value="' + (n === o ? h - i : 12 + h - i) + '"' + (h === s ? ' selected="selected"' : "") + (p && h < c.minMonth || v && h > c.maxMonth ? 'disabled="disabled"' : "") + ">" + c.i18n.months[h] + "</option>");
            }

            for (r = '<select class="datepicker-select orig-select-month" tabindex="-1">' + u.join("") + "</select>", t.isArray(c.yearRange) ? (h = c.yearRange[0], d = c.yearRange[1] + 1) : (h = n - c.yearRange, d = 1 + n + c.yearRange), u = []; h < d && h <= c.maxYear; h++) {
              h >= c.minYear && u.push('<option value="' + h + '" ' + (h === n ? 'selected="selected"' : "") + ">" + h + "</option>");
            }
          ...
          value: function value(t) {
            h._isDate(t) && t.setHours(0, 0, 0, 0);
          }
        }, {
          key: "_getDaysInMonth",
          value: function value(t, e) {
            return [31, h._isLeapYear(t) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][e];
          }
        }, {
          key: "_isLeapYear",
          value: function value(t) {
      ...
      var e = {
        ...
        function h(e, i) {
          a(this, h);
          var n = s(this, (h.__proto__ || Object.getPrototypeOf(h)).call(this, h, e, i));
          return (n.el.M_Timepicker = n).options = t.extend({}, h.defaults, i), n.id = M.guid(), n._insertHTMLIntoDOM(), n._setupModal(), n._setupVariables(), n._setupEventHandlers(), n._clockSetup(), n._pickerSetup(), n;
        }
        ...
        return o(h, r), n(h, [{
          ...
          value: function value(e) {
            ...
            this.moved && s === this.dx && o === this.dy && this.setHand(s, o), "hours" === this.currentView ? this.showView("minutes", this.options.duration / 2) : this.options.autoClose && (t(this.minutesView).addClass("timepicker-dial-out"), setTimeout(function () {
              i.done();
          ...
          value: function value() {
            for (var e = t('<div class="timepicker-tick"></div>'), i = 0; i < 60; i += 5) {
              ...
              }), n.html(h._addLeadingZero(i)), this.minutesView.appendChild(n[0]);
            }
          }
        }, {
          ...
          value: function value(t, e, i) {
            ...
            s = u * a, this.options.twelveHour ? o ? 0 === u && (u = 12) : (i && (u *= 5), 60 === u && (u = 0)) : o ? (12 === u && (u = 0), u = l ? 0 === u ? 12 : u : 0 === u ? 0 : u + 12) : (i && (u *= 5), 60 === u && (u = 0)), this[this.currentView] !== u && this.vibrate && this.options.vibrate && (this.vibrateTimer || (navigator[this.vibrate](10), this.vibrateTimer = setTimeout(function () {
              n.vibrateTimer = null;
            }, 100))), this[this.currentView] = u, o ? this.spanHours.innerHTML = u : this.spanMinutes.innerHTML = h._addLeadingZero(u);
      ...
      var e = {},
        ...
        function h(e, i) {
          a(this, h);
          var n = s(this, (h.__proto__ || Object.getPrototypeOf(h)).call(this, h, e, i));
          return (n.el.M_CharacterCounter = n).options = t.extend({}, h.defaults, i), n.isInvalid = !1, n.isValidLength = !1, n._setupCounter(), n._setupEventHandlers(), n;
        }
      ...
      var e = {
        ...
        function h(e, i) {
          a(this, h);
          var n = s(this, (h.__proto__ || Object.getPrototypeOf(h)).call(this, h, e, i));
          return (n.el.M_TapTarget = n).options = t.extend({}, h.defaults, i), n.isOpen = !1, n.$origin = t("#" + n.$el.attr("data-target")), n._setup(), n._calculatePositioning(), n._setupEventHandlers(), n;
        }
        ...
        return o(h, r), n(h, [{
          ...
          value: function value() {
            ...
            S.top = v ? _ + "px" : "", S.right = p ? l - k - g + "px" : "", S.bottom = f ? h - _ - y + "px" : "", S.left = c ? k + "px" : "", S.position = b, t(this.wrapper).css(S), t(this.contentEl).css({
              width: w + "px",
              height: C + "px",
              top: E + "px",
              right: "0px",
      ...
      var e = {
        ...
        function h(e, i) {
          a(this, h);
          var n = s(this, (h.__proto__ || Object.getPrototypeOf(h)).call(this, h, e, i));
          return n.$el.hasClass("browser-default") ? s(n) : ((n.el.M_FormSelect = n).options = t.extend({}, h.defaults, i), n.isMultiple = n.$el.prop("multiple"), n.el.tabIndex = -1, n._keysSelected = {}, n._valueDict = {}, n._setupDropdown(), n._setupEventHandlers(), n);
        }
      ...
      var l = {},
        ...
        function d(e, i) {
          a(this, d);
          var n = s(this, (d.__proto__ || Object.getPrototypeOf(d)).call(this, d, e, i));
          return (n.el.M_Range = n).options = t.extend({}, d.defaults, i), n._mousedown = !1, n._setupThumb(), n._setupEventHandlers(), n;
        }
